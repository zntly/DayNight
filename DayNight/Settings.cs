    ...
    public class Settings
    {
        ...
        public ModSettings.ColorPickerSetting DayShaderColor
        {
            get
            {
                ...
                {
                    Settings.ColorCache.SetValue("Day Shader Color", s);
                    Settings.UpdateSky();
                };
        ...
        public ModSettings.ColorPickerSetting NightShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Night Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting DawnShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Dawn Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting DuskShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Dusk Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting BloodMoonShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Blood Moon Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting StormShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Storm Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting EclipseShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Eclipse Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting WinterShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Winter Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting GreekShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Greek Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        }
        public ModSettings.ColorPickerSetting MafiaShaderColor
        {
            get
            {
                ModSettings.ColorPickerSetting colorPickerSetting = new ModSettings.ColorPickerSetting();
                colorPickerSetting.Name = "Mafia Shader Color";
                colorPickerSetting.Description = "The shader color applied when using the Mafia skybox";
                colorPickerSetting.DefaultValue = "#EFF4A5";
                colorPickerSetting.AvailableInGame = true;
                colorPickerSetting.Available = (Settings.SettingsCache.ContainsValue("Random") || ((string)Settings.SettingsCache.GetValue("Default Skybox", null) == "None" && ((string)Settings.SettingsCache.GetValue("Day Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Night Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Dawn Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Dusk Skybox", null) == "Mafia")) || (string)Settings.SettingsCache.GetValue("Default Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Day Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Apocalypse Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Tribunal Skybox", null) == "Mafia" || (ModStates.IsEnabled("curtis.tuba.better.tos2") && ((string)Settings.SettingsCache.GetValue("Court Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Daybreak Skybox", null) == "Mafia")));
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Mafia Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting VoidShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Void Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting DayShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Day Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting NightShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Night Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting DawnShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Dawn Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting DuskShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Dusk Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting BloodMoonShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Blood Moon Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting StormShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Storm Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting EclipseShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Eclipse Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting WinterShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Winter Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting GreekShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Greek Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        }
        public ModSettings.ColorPickerSetting MafiaShaderColorNight
        {
            get
            {
                ModSettings.ColorPickerSetting colorPickerSetting = new ModSettings.ColorPickerSetting();
                colorPickerSetting.Name = "Mafia Shader Color (Night)";
                colorPickerSetting.Description = "The shader color applied when using the Mafia skybox, during the in-game Night phase";
                colorPickerSetting.DefaultValue = "#686B39";
                colorPickerSetting.AvailableInGame = true;
                colorPickerSetting.Available = (Settings.SettingsCache.ContainsValue("Random") || ((string)Settings.SettingsCache.GetValue("Default Skybox", null) == "None" && ((string)Settings.SettingsCache.GetValue("Day Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Night Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Dawn Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Dusk Skybox", null) == "Mafia")) || (string)Settings.SettingsCache.GetValue("Default Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Night Skybox", null) == "Mafia" || (string)Settings.SettingsCache.GetValue("Apocalypse Skybox", null) == "Mafia");
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Mafia Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting VoidShaderColorNight
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Void Shader Color (Night)", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        public ModSettings.ColorPickerSetting JailCellShaderColor
        {
            get
            {
                ...
                colorPickerSetting.OnChanged = delegate (Color s)
                {
                    Settings.ColorCache.SetValue("Jail Cell Shader Color", s);
                    Settings.UpdateSky();
                };
                return colorPickerSetting;
            }
        ...
        private readonly List<string> AvailableSkyboxes = new List<string>(13)
        {
            "None",
            "Random",
            "Day",
        ...
        public static Dictionary<string, Color> ColorCache = new Dictionary<string, Color>
        {
            {
                "Day Shader Color",
                Color.white
            ...
            {
                "Dusk Shader Color (Night)",
                Color.white
            },
            {
                "Blood Moon Shader Color",
                Color.white
            },
            {
                "Blood Moon Shader Color (Night)",
                Color.white
            },
            {
                "Storm Shader Color",
            ...
            {
                "Storm Shader Color (Night)",
                Color.white
            },
            {
                "Eclipse Shader Color",
                Color.white
            },
            {
                "Eclipse Shader Color (Night)",
                Color.white
            },
            {
                "Winter Shader Color",
