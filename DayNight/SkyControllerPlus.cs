...
namespace DayNight
{
    ...
    public class SkyControllerPlus : MonoBehaviour
    {
        ...
        private void BuildMafiaSky()
        {
            this.mafiaDecor = UnityEngine.Object.Instantiate<GameObject>(base.transform.Find("Day").gameObject, base.transform);
            this.mafiaDecor.SetAllChildrenActive();
            this.mafiaDecor.name = "Mafia";
            this.mafiaDecor.transform.SetParent(base.transform);
            this.mafiaDecor.transform.GetComponentsInChildren<SpriteRenderer>().ForEach(delegate (SpriteRenderer s)
            {
                this.SetCloudType(s, "Invis");
            });
        ...
        {
            return (SkyInfo.SkyType)new System.Random().Next(2, 12);
        }
        ...
        private GameObject mafiaSkybox;
